...
@section('content')
    ...
    <div class="agent-user-page">
        <div class="agent-user-hero">
            <div class="agent-user-hero-main">
                ...
                <div>
                    ...
                    <h1 class="agent-user-title">Edit agent user</h1>
                    <p class="agent-user-sub">
                        Update <strong>{{ $user->name }}</strong> for <strong>{{ $agent->agent_name }}</strong>.
                    </p>
                </div>
            </div>
        ...
        <div class="agent-user-card">
            <form action="{{ route('agents.users.update', $user->id) }}" method="POST" id="agentUserForm" class="agent-user-form">
                @csrf
                @method('PUT')
                    ...
                    <div class="agent-user-pillar">
                        ...
                        <div class="agent-user-fields">
                            ...
                            <div class="form-group-custom">
                                ...
                                <textarea id="agent_user_description" name="description" class="form-control-custom" rows="4">{{ old('description', $user->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="agent-user-footer">
            <button type="submit" class="btn-save-custom" form="agentUserForm">Save changes</button>
