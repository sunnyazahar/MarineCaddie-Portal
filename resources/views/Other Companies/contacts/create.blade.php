...
@section('content')
    ...
    <div class="oc-contact-page">
        <div class="oc-contact-hero">
            <div class="oc-contact-hero-main">
                ...
                <div>
                    ...
                    <h1 class="oc-contact-title">Add contact</h1>
                    <p class="oc-contact-sub">
                        Add a contact person for <strong>{{ $otherCompany->company_name }}</strong>.
                    </p>
                </div>
            </div>
        ...
        <div class="oc-contact-card">
            <form action="{{ route('other-companies.contacts.store', $otherCompany->id) }}" method="POST" id="ocContactForm" class="oc-contact-form">
                @csrf
                    ...
                    <div class="oc-contact-pillar">
                        ...
                        <div class="oc-contact-fields">
                            ...
                            <div class="form-group-custom">
                                ...
                                <textarea id="oc_contact_description" name="description" class="form-control-custom" rows="4">{{ old('description') }}</textarea>
                            </div>
        ...
        <div class="oc-contact-footer">
            <button type="submit" class="btn-save-custom" form="ocContactForm">Save contact</button>
