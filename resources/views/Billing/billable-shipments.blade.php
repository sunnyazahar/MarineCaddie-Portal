                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-block p-1 mt-2">
                                                <div class="container-fluid p-0" data-mc-filter-persist-key="billing-billable-shipments-filter-values-v1">
                                                    <!-- Row 1 -->
                                                            ...
                                                            @foreach([
                                                                ...
                                                                @for ($j = 0; $j < 30; $j++)
                                                                    <tr>
                                                                        ...
                                                                        <td><a href="#">{{ substr(str_shuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 3) }}{{ rand(1000000, 9999999) }}-{{ 300 + $i + $j }}</a></td>
                                                                        <td>{{ $data[0] }}</td>
                                                                        <td>{{ $data[1] }}</td>
                                                                        <td>{{ $data[2] }}</td>
                                                                        <td>{{ $data[3] }}</td>
                                                                        ...
                                                                        <td>{{ $data[9] }}</td>
                                                                        <td>{{ $data[10] }}</td>
                                                                        <td><span class="badge-ready-billing">Ready for billing</span></td>
                                                                    </tr>
                                                                @endfor
                                                            @endforeach
                                                        </tbody>
