<style>
    ...
    .hub-user-page .form-group-custom {
        margin-bottom: 0;
    }

    .hub-user-page .form-label-custom {
        display: block;
        font-size: 13px;
        font-weight: 600;
        color: #475569;
    ...
    .hub-user-page .hub-user-form .form-control-custom {
        width: 100%;
    ...
    .hub-user-page .hub-user-form .form-control-custom:focus {
        outline: none;
        border-color: #0088c7;
        box-shadow: 0 0 0 3px rgba(0, 136, 199, 0.12);
    }

    .hub-user-page .hub-user-form .form-control-custom.error {
    ...
    .hub-user-checkbox input[type="checkbox"] {
        width: 16px;
        height: 16px;
        margin-top: 2px;
        flex-shrink: 0;
    ...
    body.hub-user-page .hub-user-footer {
    ...
    body.hub-user-page .hub-user-footer .btn-save-custom {
    ...
    body.hub-user-page .hub-user-footer .btn-cancel-custom {
    ...
    body.hub-user-page .hub-user-footer .btn-cancel-custom:hover {
        color: #008080 !important;
    }

    body.hub-user-page .hub-user-footer .audit-info {
        margin-left: auto;
        text-align: right;
        font-size: 11px;
        color: #94a3b8;
    ...
    body.hub-user-page .hub-user-footer .audit-info b {
        color: #64748b;
    }
