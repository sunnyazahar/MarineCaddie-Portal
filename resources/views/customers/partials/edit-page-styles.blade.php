...
<style>
    body.edit-customer-page {
        padding-bottom: 84px;
    }

    .page-body:has(.edit-customer-page) {
        padding: 0 !important;
        margin: 0 !important;
    }
    ...
    .edit-customer-meta-pill strong {
        color: #0e1d4a;
        font-weight: 800;
    }

    .edit-customer-meta-pill.is-active {
        background: #ecfdf5;
        border-color: #6ee7b7;
        color: #065f46;
    }

    .edit-customer-meta-pill.is-hidden {
        background: #f1f5f9;
        border-color: #cbd5e1;
        color: #64748b;
    }
    ...
    .form-pillar-container.cust-details-grid {
    ...
    .form-pillar.cust-pillar-card:hover {
        border-color: #94c9e3;
        box-shadow:
    ...
    #customer-details .input-row.cust-details-input-row {
        display: flex;
        gap: 10px;
        align-items: flex-start;
    ...
    #customer-details .input-row.cust-details-input-row > .form-group-custom {
        flex: 1;
        min-width: 0;
    }
    ...
    #customerForm .form-group-custom:has(> input[type="checkbox"]) {
        display: flex;
        flex-direction: row;
        align-items: flex-start;
        gap: 10px;
    ...
    #customerForm .form-group-custom:has(> input[type="checkbox"]) .form-label-custom {
        margin-bottom: 0;
        line-height: 1.35;
        font-weight: 500;
    }

    #customerForm .form-group-custom:has(> input[type="checkbox"]) input[type="checkbox"] {
        width: 16px;
        height: 16px;
        margin-top: 2px;
        flex-shrink: 0;
    ...
    #customerForm .input-row:has(input[type="checkbox"]) {
        display: flex;
        flex-direction: column;
        gap: 10px;
    }

    #customerForm .input-row.rebate-row {
        display: grid;
    ...
    #customerForm .input-grid .checkbox-group {
        grid-column: 1 / -1;
        padding-top: 0;
    }
    ...
    #customerForm .form-input-custom.error,
    #customerForm .form-textarea-custom.error {
        border-color: #dc2626 !important;
    }

    body.edit-customer-page #customerForm .select2-container--default .select2-selection--single,
    body.edit-customer-page #customerForm .select2-container--default .select2-selection--multiple {
        border: 1px solid #d6e3ee !important;
        border-radius: 8px !important;
        background: #fff !important;
    }

    body.edit-customer-page #customerForm .select2-container--default.select2-container--focus .select2-selection--single,
    body.edit-customer-page #customerForm .select2-container--default.select2-container--open .select2-selection--single {
    ...
    body.edit-customer-page .customer-edit-footer {
    ...
    body.edit-customer-page .customer-edit-footer .btn-save-custom {
    ...
    body.edit-customer-page .customer-edit-footer .btn-cancel-custom {
    ...
    body.edit-customer-page .customer-edit-footer .btn-cancel-custom:hover {
        color: #008080 !important;
    }

    body.edit-customer-page .customer-edit-footer .metadata-footer,
    body.edit-customer-page .customer-edit-footer .audit-info {
        margin-left: auto;
        text-align: right;
        font-size: 11px;
        color: #94a3b8;
    ...
    @media (max-width: 991.98px) {
        ...
        .cust-pane-toolbar .btn-cust-pane-action {
            width: 100%;
        }
    }
    ...
    .form-pillar.sop-pillar,
    .form-pillar.notification-pillar {
        height: 100%;
        min-height: 0;
    }

    .form-pillar.sop-pillar .form-textarea-custom.sop-comments-textarea {
        flex: 1 1 auto;
        min-height: 280px;
        resize: vertical;
    }

    .form-pillar.sop-pillar .upload-area.sop-upload-area {
        flex: 1 1 auto;
        min-height: 220px;
        justify-content: center;
    }

    .form-pillar.notification-pillar .checkbox-group {
        margin-bottom: 4px;
    }
