...
@section('content')
    ...
    <div class="hub-user-page">
        <div class="hub-user-hero">
            <div class="hub-user-hero-main">
                ...
                <div>
                    ...
                    <h1 class="hub-user-title">Add hub user</h1>
                    <p class="hub-user-sub">
                        Create a user for <strong>{{ $hub->hub_name }}</strong> who can appear in scan gun lists.
                    </p>
                </div>
            </div>
        ...
        <div class="hub-user-card">
            <form action="{{ route('hub.users.store', $hub->id) }}" method="POST" id="hubUserForm" class="hub-user-form">
                @csrf
        ...
        <div class="hub-user-footer">
            <button type="submit" class="btn-save-custom" form="hubUserForm">Save user</button>
