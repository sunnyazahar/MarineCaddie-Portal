...
@section('content')
    ...
    <div class="hub-contact-page">
        <div class="hub-contact-hero">
            <div class="hub-contact-hero-main">
                ...
                <div>
                    ...
                    <h1 class="hub-contact-title">Add contact</h1>
                    <p class="hub-contact-sub">
                        Add a contact person for <strong>{{ $hub->hub_name }}</strong>.
                    </p>
                </div>
            </div>
        ...
        <div class="hub-contact-card">
            <form action="{{ route('hub.contacts.store', $hub->id) }}" method="POST" id="hubContactForm" class="hub-contact-form">
                @csrf
                    ...
                    <div class="hub-contact-pillar">
                        ...
                        <div class="hub-contact-fields">
                            ...
                            <div class="form-group-custom">
                                ...
                                <textarea id="hub_contact_description" name="description" class="form-control-custom" rows="4">{{ old('description') }}</textarea>
                            </div>
        ...
        <div class="hub-contact-footer">
            <button type="submit" class="btn-save-custom" form="hubContactForm">Save contact</button>
