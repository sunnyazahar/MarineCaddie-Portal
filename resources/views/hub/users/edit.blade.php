...
@section('content')
                        ...
                        <div class="page-wrapper">
                            <div class="page-body">
                                <div class="contact-card mt-5">
                                    ...
                                    <form id="userForm" action="{{ route('hub.users.update', [$hub->id, $user->id]) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                            ...
                                            <div class="form-pillar" style="max-width: 400px;">
                                                <div class="form-group-custom">
                                                    ...
                                                    <div class="input-group-custom">
                                                        <input type="text" name="name" class="form-input-custom" value="{{ $user->name }}" required>
                                                ...
                                                <div class="form-group-custom">
                                                    ...
                                                    <input type="email" name="email" class="form-input-custom" value="{{ $user->email }}">
                                                </div>

                                                <div class="form-group-custom">
                                                    <label class="form-label-custom">Phone number</label>
                                                    <input type="text" name="phone_number" class="form-input-custom" value="{{ $user->phone_number }}">
                                                </div>

                                                <div class="checkbox-container">
                                                    <input type="checkbox" name="show_in_scan_gun" id="show_in_scan_gun" value="1" {{ $user->show_in_scan_gun ? 'checked' : '' }}>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#userForm input, #userForm textarea').on('input change', function() {
                $('#saveButton').removeClass('btn-saved-disabled').addClass('btn-teal').text('Update Hub User').css('cursor', 'pointer');
            });
