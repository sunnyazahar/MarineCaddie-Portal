...
@section('content')
    ...
    <div class="customer-contact-page">
        <div class="customer-contact-hero">
            <div class="customer-contact-hero-main">
                ...
                <div>
                    ...
                    <h1 class="customer-contact-title">Edit contact</h1>
                    <p class="customer-contact-sub">
                        Update <strong>{{ $contact->name }}</strong> for <strong>{{ $customer->customer_name }}</strong>.
                    </p>
                </div>
            </div>
        ...
        <div class="customer-contact-card">
            <form action="{{ route('contacts.update', $contact->id) }}" method="POST" id="customerContactForm" class="customer-contact-form">
                @csrf
                @method('PUT')
                    ...
                    <div class="customer-contact-pillar">
                        ...
                        <div class="customer-contact-fields">
                            ...
                            <div class="form-group-custom">
                                ...
                                <textarea id="customer_contact_description" name="description" class="form-control-custom" rows="4">{{ old('description', $contact->description) }}</textarea>
                            </div>
        ...
        <div class="customer-contact-footer">
            <button type="submit" class="btn-save-custom" form="customerContactForm">Save changes</button>
