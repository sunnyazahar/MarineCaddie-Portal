...
<!-- Pre-loader start -->
    ...
    <div class="edit-footer">
        ...
        <a href="{{ route('offices.edit', $office) }}#accounting-users" class="btn-cancel-custom">Cancel</a>
...
@include('partials.unsaved-changes-guard', ['formSelector' => '#accountUserEditForm', 'fallbackUrl' => route('offices.edit', $office->id) . '#accounting-users'])
@endsection
