...
@section('content')
    ...
    <div class="office-user-page">
            ...
            <div class="office-user-hero-main">
                ...
                <div>
                    ...
                    <p class="office-user-sub">
                        Edit sales contact for <strong>{{ $office->office_name }}</strong>.
                    </p>
                </div>
            </div>
        ...
        <div class="office-user-footer" id="sales-user-footer">
            <button type="submit" class="btn-save-custom" form="salesUserEditForm">Save user</button>
        ...
        $(document).ready(function () {
            ...
            function activateOfficeUserTab(tabId) {
                ...
                if (tabId === 'user-details') {
                    $('#sales-user-footer').show();
                } else {
                    $('#sales-user-footer').hide();
                }
            }
    ...
    @include('partials.unsaved-changes-guard', [
        'formSelector' => '#salesUserEditForm',
        'fallbackUrl' => route('offices.edit', $office->id) . '#sales-users',
    ])
@endsection
