                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                            ...
                            <div class="page-body">
                                ...
                                <div class="card">
                                    <form id="contactForm" method="POST" action="{{ route('agents.contacts.update', $contact->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="contact-form-container">
                                            <div class="form-group-custom">
                                                <label class="label-normal">Name</label>
                                                <input type="text" name="name" class="input-custom" value="{{ $contact->name }}" required>
                                            </div>

                                            <div class="form-group-custom">
                                                <label class="label-normal">Email</label>
                                                <input type="email" name="email" class="input-custom" value="{{ $contact->email }}" required>
                                            </div>

                                            <div class="form-group-custom">
                                                <label class="label-normal">Phone number (with country code)</label>
                                                <div class="input-with-icon">
                                                    <input type="text" name="phone_number" class="input-custom" value="{{ $contact->phone_number }}">
...
@include('partials.unsaved-changes-guard', ['formSelector' => '#contactForm', 'fallbackUrl' => route('agents.edit', $contact->agent_id) . '#contacts'])
@endsection