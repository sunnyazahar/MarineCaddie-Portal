    <style>
        ...
        #agentForm .agent-pillar .form-control-custom,
        #agentForm .agent-pillar .form-textarea-custom,
        #agentForm .agent-pillar .select-custom {
            width: 100%;
            border: 1px solid #d6e3ee;
            border-radius: 8px;
            background: #fff;
        ...
        #agentForm .agent-pillar .form-control-custom:focus,
        #agentForm .agent-pillar .form-textarea-custom:focus,
        #agentForm .agent-pillar .select-custom:focus {
            outline: none;
            border-color: #0088c7;
        ...
        body.create-agent-page .agent-pillar-col,
