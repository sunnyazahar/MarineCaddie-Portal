                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                            <div class="card p-5 mt-5">
                                <form action="{{ route('offices.operations_users.store', $office->id) }}" method="POST" id="operationUserForm">
                                    @csrf
                                        <div class="user-form-container">
                                            ...
                                            <div class="form-group-custom">
                                                ...
                                                <input type="email" name="reply_to_email" class="form-control-custom" value="{{ old('reply_to_email') }}">
                                            </div>
                                            <div class="checkbox-container" style="display: flex; align-items: center; gap: 10px; margin-top: 25px;">
                                                <input type="checkbox" name="is_cc_enabled" id="is_cc_enabled" value="1" {{ old('is_cc_enabled') ? 'checked' : '' }} style="width: 18px; height: 18px; cursor: pointer;">
