...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $customers = $this->customerRepo->paginate(
            $request->only(['search', 'responsible_office', 'account_manager', 'sales_manager', 'country']),
            $perPage
        );
        ...
        $responsibleOffices = $this->customerRepo->filterOffices();
        $accountManagers    = $this->customerRepo->filterAccountManagers();
        $salesManagers      = $this->customerRepo->filterSalesManagers();
        $countries          = $this->customerRepo->filterCountries();
